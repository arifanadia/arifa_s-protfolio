    ...
    return (
        <section>
            <div className="max-w-7xl mx-auto my-8 text-white">
                <h1 className="text-2xl md:text-4xl  font-bold text-transparent text-center bg-gradient-to-r from-[#7545d8] to-white bg-clip-text"> Education & Courses</h1>
                <div className="grid justify-center lg:grid-cols-3 sm:grid-cols-2 gap-4 ">
                    ...
                    <div className="bg-gray-900 rounded-md hover:border-2 hover:border-secondary_color hover:bg-secondary_color hover:bg-opacity-50 p-8 my-6 space-y-3 ">
                       ...
                       <h4 className="text-xl ">University : National University | Bangladesh </h4>
