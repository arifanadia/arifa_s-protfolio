    ...
    return (
        <section className="container mx-auto p-12">
            <div className="text-center">
                ...
                <h1 className="text-4xl font-bold text-transparent bg-gradient-to-r from-[#7545d8] to-white bg-clip-text">___My Technical Arsenal</h1>

            </div>
            <div className=" grid lg:grid-cols-5 md:grid-cols-4 grid-cols-2 gap-8 justify-around my-12 ">
