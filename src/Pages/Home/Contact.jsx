    ...
    return (
        <section id="contact" className="container mx-auto lg:flex justify-around items-center my-12">
            <div className="bg-main_color bg-opacity-30 p-12">
                <h1 className="text-2xl md:text-4xl font-bold text-transparent bg-gradient-to-r from-[#7545d8] to-white bg-clip-text">
                    Let&apos;s work together!</h1>
                <p className="md:text-xl text-white my-3">Feel free to adjust the wording to better fit your style and purpose!!</p>
            ...
            <div className="space-y-6 p-12">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="md:text-xl text-gray-50 ">Phone</h5>
                        <h3 className="text-white font-bold text-lg md:text-2xl mt-2">+88 013 14264106</h3>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="md:text-xl text-gray-50 ">Email</h5>
                        <h3 className="text-white font-bold text-lg md:text-2xl mt-2">contactarifanadia@gmail.com</h3>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="md;text-xl text-gray-50 ">Address</h5>
                        <h3 className="text-white font-bold text-lg md:text-2xl mt-2">Sylhet,Bangladesh</h3>
                    </div>
                </div>
